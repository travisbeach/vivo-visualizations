...
var tip = d3.tip().attr('class', 'd3-tip choices triangle-isosceles').attr("id", "specificTip").html(function(d) { 
  ...
  if(d.uri != null){
    result += "<p><img src='assets/whiteX.png' class='closeIcon'><b><a href='" + d.uri + "'>" + d.name + "</a></b></p>";
  }else{
    result += "<p class='nonlinktext'><img src='assets/whiteX.png' class='closeIcon'>" + d.name + "</p>";
  }
